...
from compatible_model import create_compatible_model
...
def train_compatible_model(
    ...
    # 2. 创建模型
    print(f"\n2. 创建兼容模型...")
    model = create_compatible_model(input_shape=(49, 40, 1))
    model.summary()
    ...
    model_name = f"compatible_wake_word_{timestamp}"
...
if __name__ == "__main__":
    ...
    model, history, model_path = train_compatible_model(
