...
#define VOICE_MODE_ASSIST  UINT32_C(1)
#define VOICE_MODE_RESIST  UINT32_C(2)
...
#define VOICE_MODE_DECISION_APPLY_PASSIVE       UINT32_C(7)
#define VOICE_MODE_DECISION_APPLY_ACTIVE        UINT32_C(8)
