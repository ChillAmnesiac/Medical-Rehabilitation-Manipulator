...
| Stitch MCP generation attempt | FAIL, OUTPUT REJECTED | Stitch MCP endpoint is reachable and project `projects/1542023501541093471` was created, but generated screens missed exact L1 copy such as `查看康复师建议`, `问康复师`, `我的康复档案`, `绑定手机号`, `验证码`, `绑定设备`, and `打开康复设备电源`; no generated HTML was copied into frontend source |
