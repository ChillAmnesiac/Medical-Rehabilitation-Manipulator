  ...
  public PatientDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfPatient = new EntityInsertionAdapter<Patient>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `patients` (`id`,`name`,`age`,`gender`,`diagnosis`,`admissionDate`,`doctorId`,`notes`,`currentROM`,`strengthLevel`,`latestScore`,`isActive`,`createdAt`,`updatedAt`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindLong(6, entity.getAdmissionDate());
        statement.bindString(7, entity.getDoctorId());
        statement.bindString(8, entity.getNotes());
        statement.bindDouble(9, entity.getCurrentROM());
        statement.bindLong(10, entity.getStrengthLevel());
        statement.bindDouble(11, entity.getLatestScore());
    ...
    this.__updateAdapterOfPatient = new EntityDeletionOrUpdateAdapter<Patient>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `patients` SET `id` = ?,`name` = ?,`age` = ?,`gender` = ?,`diagnosis` = ?,`admissionDate` = ?,`doctorId` = ?,`notes` = ?,`currentROM` = ?,`strengthLevel` = ?,`latestScore` = ?,`isActive` = ?,`createdAt` = ?,`updatedAt` = ? WHERE `id` = ?";
      }
      ...
      public List<Patient> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Patient(_tmpId,_tmpName,_tmpAge,_tmpGender,_tmpDiagnosis,_tmpAdmissionDate,_tmpDoctorId,_tmpNotes,_tmpCurrentROM,_tmpStrengthLevel,_tmpLatestScore,_tmpIsActive,_tmpCreatedAt,_tmpUpdatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public Patient call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpUpdatedAt;
            _tmpUpdatedAt = _cursor.getLong(_cursorIndexOfUpdatedAt);
            _result = new Patient(_tmpId,_tmpName,_tmpAge,_tmpGender,_tmpDiagnosis,_tmpAdmissionDate,_tmpDoctorId,_tmpNotes,_tmpCurrentROM,_tmpStrengthLevel,_tmpLatestScore,_tmpIsActive,_tmpCreatedAt,_tmpUpdatedAt);
          } else {
            _result = null;
          }
          return _result;
